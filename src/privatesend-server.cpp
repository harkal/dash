...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if(fLiteMode) return; // ignore all Ebakus related functionality
...
/*
    ...
    allow endless transaction that would bloat Ebakus and make it unusable. To
    stop these kinds of attacks 1 in 10 successful transactions are charged. This
    adds up to a cost of 0.001EBK per transaction on average.
*/
