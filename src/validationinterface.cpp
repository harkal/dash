...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.PubKeyForMining.connect(boost::bind(&CValidationInterface::GetPubKeyForMining, pwalletIn, _1));
    g_signals.BlockFound.connect(boost::bind(&CValidationInterface::ResetRequestCount, pwalletIn, _1));
}

void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    g_signals.BlockFound.disconnect(boost::bind(&CValidationInterface::ResetRequestCount, pwalletIn, _1));
    g_signals.PubKeyForMining.disconnect(boost::bind(&CValidationInterface::GetPubKeyForMining, pwalletIn, _1));
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.PubKeyForMining.disconnect_all_slots();
