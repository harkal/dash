...
inline H256 Hash(const T1 pbegin, const T1 pend)
{
...
inline H256 Hash(const T1 p1begin, const T1 p1end,
...
inline H256 Hash(const T1 p1begin, const T1 p1end,
    ...
    static const unsigned char pblank[1] = {};
    H256 result;
    CKeccak256().Write(p1begin == p1end ? pblank : (const unsigned char*)&p1begin[0], (p1end - p1begin) * sizeof(p1begin[0]))
              .Write(p2begin == p2end ? pblank : (const unsigned char*)&p2begin[0], (p2end - p2begin) * sizeof(p2begin[0]))
              .Write(p3begin == p3end ? pblank : (const unsigned char*)&p3begin[0], (p3end - p3begin) * sizeof(p3begin[0]))
              .Write(p4begin == p4end ? pblank : (const unsigned char*)&p4begin[0], (p4end - p4begin) * sizeof(p4begin[0]))
              .Write(p5begin == p5end ? pblank : (const unsigned char*)&p5begin[0], (p5end - p5begin) * sizeof(p5begin[0]))
...
template<typename T1>
inline H160 Hash160(const T1 pbegin, const T1 pend)
{
...
inline H160 Hash160(const std::vector<unsigned char>& vch)
{
...
inline H160 Hash160(const prevector<N, unsigned char>& vch)
{
    return Hash160(vch.begin(), vch.end());
}
...
template<typename T>
H256 SerializeHash(const T& obj, int nType=SER_GETHASH, int nVersion=PROTOCOL_VERSION)
{
