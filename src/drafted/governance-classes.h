 ...
 *
 *   // network
 *   CEbakusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ebakus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEbakusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EbakusNetwork
// //   -- signature requirements : Key1(User)
// class CEbakusNetworkVariable : public CGovernanceObject
// {
// private:
