...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EbakusNetwork") type = EbakusNetwork;
    if(strType == "EbakusNetworkVariable") type = EbakusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EbakusNetwork) s = "EbakusNetwork";
    if(type == EbakusNetworkVariable) s = "EbakusNetworkVariable";
