...
//! These need to be macros, as clientversion.cpp's and ebakus*-res.rc's voodoo requires it
...
/**
 * ebakusd-res.rc includes this file, but it cannot cope with real c++ code.
