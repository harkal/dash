...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ebakus Core ebakus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ebakus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ebakus transaction") + "\n" +
              "  ebakus-tx [options] -create [commands]   " + _("Create hex-encoded ebakus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ebakus transaction
