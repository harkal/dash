    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ebakus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ebakus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ebakus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ebakus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EBAKUS, 0.1 EBAKUS, 1 EBAKUS and 10 EBAKUS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ebakuspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ebakuspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ebakus Core is shutting down...") + "<br /><br />" +
