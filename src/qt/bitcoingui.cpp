    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ebakus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ebakus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ebakus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ebakus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ebakus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ebakus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ebakus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ebakus addresses"));
    ...
    openAction->setStatusTip(tr("Open a ebakus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ebakus Core help message to get a list with possible Ebakus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ebakus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ebakus network", "", count));
}
...
{
    QString strTitle = tr("Ebakus Core"); // default title
