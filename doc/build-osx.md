...
dashd/dash-cli binaries are not included in the Ebakus-Qt.app bundle.

If you are building `dashd` or `Ebakus Core` for others, your build machine should be set up
