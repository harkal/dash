...
Only requiring some minor changes is ebakus.cpp.
...
Changes to ebakus.cpp
----------------------
ebakus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
