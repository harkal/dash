...
This mechanism has been integrated into Bitcore-Node-Ebakus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ebakuspay/insight-api-ebakus#web-socket-api](https://github.com/ebakuspay/insight-api-ebakus#web-socket-api) 
* API: [https://github.com/ebakuspay/insight-api-ebakus#instantsend-transactions](https://github.com/ebakuspay/insight-api-ebakus#instantsend-transactions) 
...
By default, the Ebakus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ebakus Core daemon:
